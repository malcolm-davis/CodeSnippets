...
public class JsonPathDemo {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Start: JsonPathDemo ");
        System.out.println("---------------------------------------------");

        long start = System.currentTimeMillis();

        JsonPathDemo test = new JsonPathDemo();
        test.run();
    ...
    private void run() throws Exception {
        ...
        SysOut(document, "displayId");
        SysOut(document, "userId");
        SysOut(document, "status");
        SysOut(document, "callback");
        System.out.println("Runtime: " + (System.currentTimeMillis()-start));
    }

    private void SysOut(Object document, String field) throws Exception {
        Object output = JsonPath.read(document, "$."+field);

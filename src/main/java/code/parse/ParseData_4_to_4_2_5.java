...
public class ParseData_4_to_4_2_5 {
    ...
    public static void main(String[] args) {
        ...
        ParseData_4_to_4_2_5 test = new ParseData_4_to_4_2_5();
        test.run();
    ...
    public static final String DATA =
            "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/abstractDialButtonOrdering.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/abstractDialButtonOrdering.xml\r\n" +
                    "19,22c19\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/abstractDialButton.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/abstractDialButton.xml\r\n" +
                    "10c10\r\n" +
                    ...
                    "---\r\n" +
                    ">         <value name=\"dispatchGroup\" get-method=\"getDispatchGroupName\" set-method=\"setDispatchGroupName\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/abstractHasLocation.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/abstractHasLocation.xml\r\n" +
                    "8,9c8\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/applicationContext.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/applicationContext.xml\r\n" +
                    "19,30d18\r\n" +
                    ...
                    "50d25\r\n" +
                    "< \r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/asteriskConfig.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/asteriskConfig.xml\r\n" +
                    "9,10c9\r\n" +
                    ...
                    ">               marshaller=\"org.jibx.extras.DomElementMapper\" unmarshaller=\"org.jibx.extras.DomElementMapper\"/>\r\n" +
                    ">         </structure>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/autodialContext.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/autodialContext.xml\r\n" +
                    "10,12c10,12\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/cadFormatter.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/cadFormatter.xml\r\n" +
                    "7,9c7,9\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/cadOutput.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/cadOutput.xml\r\n" +
                    "7a8\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/callConfig.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/callConfig.xml\r\n" +
                    "14,16d13\r\n" +
                    "<         <value name=\"textCallCleanupInterval\" field=\"textCallCleanupInterval\" usage=\"optional\"\r\n" +
                    "<                 serializer=\"com.clj2.business.config.ParseUtil.serializeOptionalTimeInterval\"\r\n" +
                    "<                 deserializer=\"com.clj2.business.config.ParseUtil.deserializeOptionalTimeInterval\"/>\r\n" +
                    "20c17,19\r\n" +
                    ...
                    ">         </collection>\r\n" +
                    "Only in /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config: callDiversion.xml\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/cdrFormatter.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/cdrFormatter.xml\r\n" +
                    "7,9c7,9\r\n" +
                    "<         <value name=\"format\" get-method=\"getFormat\" set-method=\"setFormat\"\r\n" +
                    "<           serializer=\"org.dellroad.stuff.jibx.ParseUtil.serializeString\"\r\n" +
                    "<           deserializer=\"org.dellroad.stuff.jibx.ParseUtil.deserializeString\"/>\r\n" +
                    ...
                    ">           serializer=\"com.clj2.business.lib.serial.NamedELArgumentFormatter.serialize\"\r\n" +
                    ">           deserializer=\"com.clj2.business.lib.serial.NamedELArgumentFormatter.deserialize\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/cdrOutput.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/cdrOutput.xml\r\n" +
                    "10d9\r\n" +
                    "<         <value name=\"redialSpillSupport\" field=\"redialSpillSupport\" default=\"true\"/>\r\n" +
                    "12a12\r\n" +
                    ">         <value name=\"sendAsXML\" field=\"sendAsXML\" usage=\"optional\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/clusterConfig.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/clusterConfig.xml\r\n" +
                    "16a17,18\r\n" +
                    ">         <value name=\"federation\" field=\"federationUUID\" deserializer=\"org.dellroad.stuff.jibx.ParseUtil.deserializeUUID\"\r\n" +
                    ">           usage=\"optional\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/currentUserCallTableSection.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/currentUserCallTableSection.xml\r\n" +
                    "6a7\r\n" +
                    ">         <value name=\"initialRows\" field=\"initialRows\" default=\"3\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/directoryEntryType.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/directoryEntryType.xml\r\n" +
                    "9a10\r\n" +
                    ">         <value name=\"dispatchGroup\" field=\"dispatchGroupName\" usage=\"optional\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/directoryEntry.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/directoryEntry.xml\r\n" +
                    "9c9\r\n" +
                    "<         <value name=\"preferredNumber\" field=\"preferredNumber\" style=\"attribute\" usage=\"optional\"/>\r\n" +
                    "---\r\n" +
                    ">         <value name=\"preferredContact\" field=\"preferredContact\" style=\"attribute\" usage=\"optional\"/>\r\n" +
                    ...
                    "---\r\n" +
                    ">         <value name=\"dispatchGroup\" get-method=\"getDispatchGroupName\" set-method=\"setDispatchGroupName\" usage=\"optional\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/dispatchGroup.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/dispatchGroup.xml\r\n" +
                    "6d5\r\n" +
                    ...
                    ">             <value name=\"dispatchGroup\" type=\"java.lang.String\"/>\r\n" +
                    ">         </collection>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/e911Init.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/e911Init.xml\r\n" +
                    "7a8,11\r\n" +
                    ...
                    ">             <structure name=\"DialSetup\" map-as=\"dialSetup\"/>\r\n" +
                    ">         </collection>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/e911Service.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/e911Service.xml\r\n" +
                    "13,15d12\r\n" +
                    "<     <include path=\"adminPhone.xml\"/>\r\n" +
                    "<     <include path=\"position.xml\"/>\r\n" +
                    "<     <include path=\"aiu.xml\"/>\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/extVoicemail.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/extVoicemail.xml\r\n" +
                    "7d6\r\n" +
                    "<         <value name=\"password\" field=\"password\" usage=\"optional\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/fact.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/fact.xml\r\n" +
                    "11,12c11,12\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/guiConfig.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/guiConfig.xml\r\n" +
                    "27a28,30\r\n" +
                    ...
                    ">         </collection>\r\n" +
                    "Only in /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config: guiConnectionLostBanner.xml\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/guiConnectionStatuses.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/guiConnectionStatuses.xml\r\n" +
                    "5a6\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/guiTabs.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/guiTabs.xml\r\n" +
                    "15a16\r\n" +
                    ...
                    "Only in /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config: hostPort.xml\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/incidentPriority.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/incidentPriority.xml\r\n" +
                    "8a9,10\r\n" +
                    ">         <value name=\"abbreviation\" field=\"abbreviation\"/>\r\n" +
                    ">         <value name=\"position\" field=\"position\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/incidentStatus.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/incidentStatus.xml\r\n" +
                    "8a9\r\n" +
                    ">         <value name=\"abbreviation\" field=\"abbreviation\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/localAreaCode.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/localAreaCode.xml\r\n" +
                    "7c7\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/location.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/location.xml\r\n" +
                    "9a10,11\r\n" +
                    ">         <value name=\"FCCID\" field=\"fccID\" usage=\"optional\"/>\r\n" +
                    ">         <value name=\"PSAPName\" field=\"psapName\" usage=\"optional\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/outboundRoute.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/outboundRoute.xml\r\n" +
                    "9a10\r\n" +
                    ">         <value name=\"destination\" field=\"destination\" usage=\"optional\"/>\r\n" +
                    "Only in /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config: phoneDirectory.xml\r\n" +
                    "Only in /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config: phoneEntry.xml\r\n" +
                    "Only in /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config: printer.xml\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/queueACD.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/queueACD.xml\r\n" +
                    "14a15\r\n" +
                    ">         <value name=\"abandonedCallSchedulingEnabled\" field=\"abandonedCallSchedulingEnabled\" usage=\"optional\" default=\"false\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/sipPeer.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/sipPeer.xml\r\n" +
                    "24a25\r\n" +
                    ">         <value name=\"requestProgress\" field=\"requestProgress\" usage=\"optional\" dfault=\"false\"/>\r\n" +
                    "28a30,31\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/siteConfig.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/siteConfig.xml\r\n" +
                    "27a28,30\r\n" +
                    ...
                    "Only in /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config: sys\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/tandemTransfer.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/tandemTransfer.xml\r\n" +
                    "5a6\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/trunk.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/trunk.xml\r\n" +
                    "13a14\r\n" +
                    ">         <value name=\"requestProgress\" field=\"requestProgress\" usage=\"optional\" default=\"false\"/>\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/unitStatus.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/unitStatus.xml\r\n" +
                    "9a10\r\n" +
                    ">         <value name=\"abbreviation\" field=\"abbreviation\"/>\r\n" +
                    "11a13,15\r\n" +
                    ...
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/unitTypeGroup.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/unitTypeGroup.xml\r\n" +
                    "8a9\r\n" +
                    ">         <value name=\"icon\" field=\"icon\"/>\r\n" +
                    "Common subdirectories: /projects/codereview/4.0-branch/src/java/com/clj2/business/config/updates and /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/updates\r\n" +
                    "diff -x '*.java' -I '^.*Copyright.*$' -I '^.*$Id:.*$' /projects/codereview/4.0-branch/src/java/com/clj2/business/config/webaccessoryConfig.xml /projects/codereview/4.2.5-branch/src/java/com/clj2/business/config/webaccessoryConfig.xml\r\n" +
                    "15a16\r\n" +
